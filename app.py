...
sidebar = html.Div(
    [
        ...
        html.H5("CoviPrev", className="navbar-subtitle"),
        dbc.Nav(
            [
                dbc.NavLink("Accueil", href="/", active="exact",
                            className="text-navbar"),
                dbc.NavLink("Dépression", href="/page-1",
                            active="exact", className="text-navbar"),
                dbc.NavLink("Sommeil", href="/page-2",
                            active="exact", className="text-navbar"),
            ],
            # html.Hr(),
            # html.P(
...
def render_page_content(pathname):
    if pathname == "/":
        return [
            ...
            html.P("Une enquête pour suivre l’évolution des comportements et de la santé mentale pendant l'épidémie de COVID-19. Depuis le 23 mars 2020, Santé publique France a lancé l'enquête CoviPrev en population générale afin de suivre l’évolution des comportements (gestes barrières, confinement, consommation d’alcool et de tabac, alimentation et activité physique) et de la santé mentale (bien-être, troubles).",
                   className='content-paraf'),
            html.P("Source de l'enquête ici", className="content-warning"),
            ...
            #             ])]
            dcc.Graph(id='bargraph', figure=fig_all,
